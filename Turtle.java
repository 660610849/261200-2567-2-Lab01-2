...
// วาดน้ำ
        ...
        bob.down();
// วาดพื้นที่น้ำแบบเติมสี
        for (int y = 0; y > -200; y -= 5) {
            bob.up();
            bob.setPosition(-300, y);
            bob.down();
            bob.forward(600);
        }
        ...
        bob.penColor("yellow");
        bob.up();
        bob.setPosition(25, -10);
        bob.down();
        for (int i = -10; i < 0; i += 1) {
            bob.up();
            bob.setPosition(20, i);
            bob.down();
            for (int j = 0; j < 4; j++) {
                bob.forward(10);
                bob.left(90);
        ...
        bob.up();
        bob.setPosition(40, -10);
        bob.down();
        for (int i = -10; i < 0; i += 1) {
            bob.up();
            bob.setPosition(35, i);
            bob.down();
            for (int j = 0; j < 4; j++) {
                bob.forward(10);
                bob.left(90);
        ...
        bob.up();
        bob.setPosition(120, -10);
        bob.down();
        for (int i = -10; i < 0; i += 1) {
            bob.up();
            bob.setPosition(115, i);
            bob.down();
            for (int j = 0; j < 4; j++) {
                bob.forward(10);
                bob.left(90);
